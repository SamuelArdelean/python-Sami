...
input_frame=Frame(window, width=300, height=50)
...
frame_butoane=Frame(window, width=400, height=300, bg='grey')
frame_butoane.pack()

buton_stergere= Button(frame_butoane, text='C', width=50, height=3, bg='#eee', cursor='hand2',
...
sapte=Button(frame_butoane,text='7',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('7')).grid(row=1,column=0)
opt=Button(frame_butoane,text='8',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('8')).grid(row=1,column=1)
noua=Button(frame_butoane,text='9',width=10,height=3,bg='#eee', cursor='hand2',
...
patru=Button(frame_butoane,text='4',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('4')).grid(row=2,column=0)
cinci=Button(frame_butoane,text='5',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('5')).grid(row=2,column=1)
sase=Button(frame_butoane,text='6',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('6')).grid(row=2,column=2)
minus=Button(frame_butoane,text='-',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('-')).grid(row=2,column=3)

unu=Button(frame_butoane,text='1',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('1')).grid(row=3,column=0)
doi=Button(frame_butoane,text='2',width=10,height=3,bg='#eee', cursor='hand2',
             command=lambda:click('2')).grid(row=3,column=1)
trei=Button(frame_butoane,text='3',width=10,height=3,bg='#eee', cursor='hand2',
...
zero=Button(frame_butoane,text='0',width=10,height=3,bg='#eee', cursor='hand2',
...
egal=Button(frame_butoane,text='=',width=10,height=3,bg='#eee', cursor='hand2',
